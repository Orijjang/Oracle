...
INSERT INTO ACCOUNT VALUES ('101-13-1002','S2','정기적립예금','830513-2000003',1020000,'2005-05-13 13:20:12');
INSERT INTO ACCOUNT VALUES ('101-11-1003','S1','자유저축예금','870830-1000004',53000,'2005-03-17 21:54:06');
INSERT INTO ACCOUNT VALUES ('101-21-1004','L1','고객신용대출','910913-2000005',1200500,'2005-08-25 14:34:57');
INSERT INTO ACCOUNT VALUES ('101-13-1005','S3','주택청약예금','941127-1000006',720800,'2005-10-15 19:56:34');
...
INSERT INTO TRANSACTION VALUES (1,'101-11-1001',1, 50000,'2025-07-1213:55:31');
...
--실습 3-10
SELECT * FROM ACCOUNT 
WHERE ACC_BALANCE >= 1000000 AND ACC_NAME = '자유저축예금';
--실습 3-11
...
--#실습 3-15#
/*SELECT SUM(TR_TYPE=1) AS 입금총합, AVG(TR_TYPE=1) AS 입금평균
FROM TRANSACTION WHERE TR_TYPE=1;
*/
/*
SELECT
    SUM(CASE WHEN TR_TYPE = 1 THEN TR_AMOUNT ELSE 0 END) AS 입금총합,
    AVG(CASE WHEN TR_TYPE = 1 THEN TR_AMOUNT END)        AS 입금평균
FROM TRANSACTION;
*/
SELECT 
